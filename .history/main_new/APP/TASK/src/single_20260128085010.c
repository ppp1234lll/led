...
Params_t test_nmotor[COLOR_MAX] = {
	{.current = &g_singleboard_t[1].data.current[6], .voltage = &g_singleboard_t[1].data.voltage[0], .pulse = &g_singleboard_t[1].data.pulse[0]},
	{.current = &g_singleboard_t[1].data.current[8], .voltage = &g_singleboard_t[1].data.voltage[1], .pulse = &g_singleboard_t[1].data.pulse[1]},
	{.current = &g_singleboard_t[1].data.current[7], .voltage = &g_singleboard_t[1].data.voltage[2], .pulse = &g_singleboard_t[1].data.pulse[2]}
};
