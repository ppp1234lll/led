...
uint8_t hardSPI_ReadWriteByte(uint8_t TxData)
{
	...
	if (HAL_SPI_TransmitReceive(&hspi1, &TxData, &RecevieData, 4, HAL_MAX_DELAY) != HAL_OK)
{
    Error_Handler();
}
...
void hardSPI_Write_Multi_Byte(uint8_t *buff, uint16_t len)
{
	...
	if (HAL_SPI_Transmit(&hspi1, buff, len, HAL_MAX_DELAY)!= HAL_OK)
{
    Error_Handler();
}
}
...
uint8_t hardSPI_2_ReadWriteByte(uint8_t TxData)
{
	...
	if (HAL_SPI_TransmitReceive(&hspi2, &TxData, &RecevieData, 4, HAL_MAX_DELAY) != HAL_OK)
{
    Error_Handler();
}
...
void hardSPI_2_Write_Multi_Byte(uint8_t *buff, uint16_t len)
{
	...
	if (HAL_SPI_Transmit(&hspi2, buff, len, HAL_MAX_DELAY)!= HAL_OK)
{
    Error_Handler();
}
}
...
uint8_t hardSPI_3_ReadWriteByte(uint8_t TxData)
{
	...
	if (HAL_SPI_TransmitReceive(&hspi3, &TxData, &RecevieData, 4, HAL_MAX_DELAY) != HAL_OK)
{
    Error_Handler();
}
...
void hardSPI_3_Write_Multi_Byte(uint8_t *buff, uint16_t len)
{
	...
	if (HAL_SPI_Transmit(&hspi3, buff, len, HAL_MAX_DELAY)!= HAL_OK)
{
    Error_Handler();
}
}
