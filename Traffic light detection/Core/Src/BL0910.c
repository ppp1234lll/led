...
static uint8_t  sg_bl0910_buff[64] = {0};
struct bl0910_data_t sg_bl0910data_t = {0};

/* 接口与参数 */
#define BL0910_BAUDRATE (4800)
//#define BL0910_INIT() 							elec_hard_spi_init()
#define BL0910_SEND_STR(buff,len) 	hardSPI_Write_Multi_Byte(buff,len)

/* 宏定义数据 */
#define BL0910_DET_NUM   			10  		// 采集次数 
#define BL0910_TIME_OUT  			20 		// 超时时间 20ms
#define BL0910_AUTO_TIME   		200 	  // 2s (采集18次，每次100ms)
...
/************************************************************
*
* Function name	: bl0910_init_function
* Description	: 初始化                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  
* Parameter		: 
* Return		: 
*	
...
////	bl0910_set_gain_function();  // 设置增益
////	delay_ms(10);
////	bl0910_set_ch_function();
////	delay_ms(10);	
//	bl0910_set_mode_function();
////	bl0910_set_eng_rst_function();
//	delay_ms(10);
//	bl0910_reset_numreg_function();
//	/* 写命令失能 */
//	bl0910_write_enable_function(0);
//	delay_ms(100);
}
...
/************************************************************
*
* Function name	: bl0910_sending_data_function
* Description	: 发送数据函数
* Parameter		: 
*	@reg		: 寄存器值
*	@mode		: 发送模式
...
/************************************************************
*
* Function name	: bl0910_send_over_function
...
/************************************************************
*
* Function name	: bl0910_deal_read_data_function
...
int8_t bl0910_deal_read_data_function(void)
{
	...
	{
		case I10_RMS:  det_set_total_energy(1,data); break;
		case I9_RMS:   det_set_total_energy(2,data); break;
		case I8_RMS:   det_set_total_energy(3,data); break;
		case I7_RMS:   det_set_total_energy(4,data); break;
		case I6_RMS:   det_set_total_energy(5,data); break;
		case I5_RMS:   det_set_total_energy(6,data); break;
		case I4_RMS:   det_set_total_energy(7,data); break;
		case I3_RMS:   det_set_total_energy(8,data); break;
		case I2_RMS:   det_set_total_energy(9,data); break;
		case I1_RMS:   det_set_total_energy(10,data); break;
		default:			break;
	}
	return ret;
}
...
/************************************************************
*
* Function name	: bl0910_repeat_function
* Description	: 重复操作函数
* Parameter		: 
* Return		: 
*	
...
/************************************************************
*
* Function name	: bl0910_analysis_data_function
* Description	: 数据读取函数
* Parameter		: 
* Return		: 
*	
...
/************************************************************
*
* Function name	: bl0910_write_reg_function
* Description	: 写寄存器
* Parameter		: 
* Return		: 
*	
...
/************************************************************
*
* Function name	: bl0910_read_reg_function
* Description	: 寄存器读取命令
* Parameter		: 
*	@reg		: 寄存器值
...
void bl0910_read_reg_function(uint8_t reg, uint8_t mode)
{
	...
	for(index=0; index < 4; index++) {
		BL0910_REC_BUFF[index] = hardSPI_ReadByte();
	}
...
/************************************************************
*
* Function name	: bl0910_send_data_function
* Description	: 数据发送函数
* Parameter		: 
* Return		: 
*	
	...
	if(sg_bl0910data_t.send == 0)
	{
		if(sg_bl0910data_t.flag > 0)
		{
			...
			switch(sg_bl0910data_t.flag)
			{
				...
				case 1: 	bl0910_read_reg_function(I10_RMS,0); break; // 电流 
				case 2: 	bl0910_read_reg_function(I9_RMS,0); break; // 电流 
				case 3: 	bl0910_read_reg_function(I8_RMS,0); break; // 电流 
				case 4: 	bl0910_read_reg_function(I7_RMS,0); break; // 电流 
				case 5: 	bl0910_read_reg_function(I6_RMS,0); break; // 电流			
				case 6: 	bl0910_read_reg_function(I5_RMS,0); break; // 电流 
				case 7: 	bl0910_read_reg_function(I4_RMS,0); break; // 电流 
				case 8: 	bl0910_read_reg_function(I3_RMS,0); break; // 电流 
				case 9: 	bl0910_read_reg_function(I2_RMS,0); break; // 电流 
        case 10: 	bl0910_read_reg_function(I1_RMS,0); break; // 电流 				
				default: break;			
			}
...
/************************************************************
*
* Function name	: bl0910_run_timer_function
...
/************************************************************
*
* Function name	: bl0910_work_process_function
* Description	: 工作进程函数
* Parameter		: 
* Return		: 
*	
...
/************************************************************
*
* Function name	: bl0910_get_rec_data_function
* Description	: 获取通信数据
* Parameter		: 
*	@
* Return: 
...
/************************************************************
*
* Function name	: bl0910_write_enable_function
* Description	: 写使能控制函数
* Parameter		: 
*	@cmd		: 0-失能 1-使能
* Return		: 
...
/************************************************************
*
* Function name	: bl0910_set_gain_function
* Description	: 设置增益寄存器
* Parameter		: 
* Return		: 
*	
...
/************************************************************
*
* Function name	: bl0910_set_ch_function
* Description	: 设置通道寄存器
* Parameter		: 
* Return		: 
*	
...
/************************************************************
*
* Function name	: bl0910_set_mode_function
* Description	: 设置模式
* Parameter		: 
* Return		: 
*	
...
/************************************************************
*
* Function name	: bl0910_set_eng_rst_function
* Description	: 能量读后清零
* Parameter		: 
* Return		: 
*	
...
/************************************************************
*
* Function name	: bl0910_reset_numreg_function
