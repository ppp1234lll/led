...
struct bl0906_data_t {
	...
	uint8_t det_num;    // 采集次数
};

static uint16_t sg_bl0906_rec_sta = 0;
static uint8_t  sg_bl0906_buff[64] = {0};
struct bl0906_data_t sg_bl0906data_t = {0};

/* 接口与参数 */
#define BL0906_BAUDRATE (4800)
#define BL0906_INIT() 							bl0906_elec_hard_spi_init()
#define BL0906_SEND_STR(buff,len) 	hardSPI_3_Write_Multi_Byte(buff,len)

/* 宏定义数据 */
#define BL0906_ID	   					1  			// 芯片数量
#define BL0906_ONE_NUM   			10  			// 每个芯片采集次数 
#define BL0906_DET_NUM   			10   // 采集总次数 
#define BL0906_AUTO_TIME   		200 	  // 2s (采集24次)
/* 数据 */
...
/************************************************************
*
* Function name	: bl0906_init_function
* Description	: 初始化                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  
* Parameter		: 
* Return		: 
*	
...
//	HAL_Delay(10);
//	bl0906_set_gain_function();  // 设置增益
//	HAL_Delay(10);
////	bl0906_set_ch_function();
////	HAL_Delay(10);	
//	bl0906_set_mode1_function();
//	HAL_Delay(10);
//	bl0906_set_mode2_function();
//	HAL_Delay(10);
//	bl0910_set_ADC_PD_function();
////	bl0906_set_eng_rst_function();
//	HAL_Delay(10);
...
/************************************************************
*
* Function name	: bl0906_sending_data_function
* Description	: 发送数据函数
* Parameter		: 
*	@reg		: 寄存器值
*	@mode		: 发送模式
...
/************************************************************
*
* Function name	: bl0906_send_over_function
...
//*	
//************************************************************/
//uint32_t Complement_2_Original1(uint32_t data)
//{
//	uint32_t temp;
...
/************************************************************
*
* Function name	: bl0906_deal_read_data_function
...
int8_t bl0906_deal_read_data_function(void)
{
	...
	{
		case BL0906_I1_RMS:    det_set_total_energy(24,data); break;
		case BL0906_I2_RMS:    det_set_total_energy(23,data); break;
		case BL0906_I3_RMS:    det_set_total_energy(22,data); break;
		case BL0906_I4_RMS:    det_set_total_energy(21,data); break;
...
/************************************************************
*
* Function name	: bl0906_repeat_function
* Description	: 重复操作函数
* Parameter		: 
* Return		: 
*	
...
/************************************************************
*
* Function name	: bl0906_analysis_data_function
* Description	: 数据读取函数
* Parameter		: 
* Return		: 
*	
...
/************************************************************
*
* Function name	: bl0906_write_reg_function
* Description	: 写寄存器
* Parameter		: 
* Return		: 
*	
...
/************************************************************
*
* Function name	: bl0906_read_reg_function
* Description	: 寄存器读取命令
* Parameter		: 
*	@reg		: 寄存器值
...
void bl0906_read_reg_function(uint8_t reg, uint8_t mode)
{
	...
	for(index=0; index < 4; index++) {
		BL0906_REC_BUFF[index] = hardSPI_3_ReadByte();
	}
...
/************************************************************
*
* Function name	: bl0906_send_data_function
* Description	: 数据发送函数
* Parameter		: 
* Return		: 
*	
...
void bl0906_send_data_function(void)
{
	...
	{
		sg_bl0906data_t.det_num--;
		if(sg_bl0906data_t.det_num > 0)
		{	
			switch(sg_bl0906data_t.det_num)
			{			
				case 1: 	
					bl0906_read_reg_function(BL0906_I1_RMS,0); break; 
				case 2: 	
					bl0906_read_reg_function(BL0906_I2_RMS,0); break; 
				case 3: 	
					bl0906_read_reg_function(BL0906_I3_RMS,0); break; 
				case 4: 	
					bl0906_read_reg_function(BL0906_I4_RMS,0); break; 
				default: break;			
			}
		}
	}
...
/************************************************************
*
* Function name	: bl0906_run_timer_function
...
void bl0906_run_timer_function(void)
{
	...
	if(sg_bl0906data_t.auto_cmd == 1) 
	{
		...
		{
			auto_time = 0;
			sg_bl0906data_t.det_num = BL0906_DET_NUM;
			sg_bl0906data_t.send = 0;
		}
	} 
	else 
...
/************************************************************
*
* Function name	: bl0906_work_process_function
* Description	: 工作进程函数
* Parameter		: 
* Return		: 
*	
...
/************************************************************
*
* Function name	: bl0906_get_rec_data_function
* Description	: 获取通信数据
* Parameter		: 
*	@
* Return: 
...
/************************************************************
*
* Function name	: bl0906_write_enable_function
* Description	: 写使能控制函数
* Parameter		: 
*	@cmd		: 0-失能 1-使能
* Return		: 
...
/************************************************************
*
* Function name	: bl0906_set_gain_function
* Description	: 设置增益寄存器
* Parameter		: 
* Return		: 
*	
...
void bl0906_set_gain_function(void)
{
	...
	gain1_buff[0] = BL0906_GAIN_16<<4 | BL0906_GAIN_16;  // 通道1 电压通道
	gain1_buff[1] = BL0906_GAIN_16<<4 | BL0906_GAIN_16;  // 通道3 通道2
	gain1_buff[2] = BL0906_GAIN_16<<4 | BL0906_GAIN_16;  // 通道5 通道4

	gain2_buff[0] = BL0906_GAIN_16<<4 | BL0906_GAIN_16;  // 通道7 通道6
	gain2_buff[1] = BL0906_GAIN_16<<4 | BL0906_GAIN_16;  // 通道9 通道8
	gain2_buff[2] = BL0906_GAIN_16;  						 // 通道10
...
/************************************************************
*
* Function name	: bl0906_set_ch_function
* Description	: 设置通道寄存器
* Parameter		: 
* Return		: 
*	
...
/************************************************************
*
* Function name	: bl0910_set_mode1_function
* Description	: 设置模式
* Parameter		: 
* Return		: 
*	
************************************************************/
void bl0906_set_mode1_function(void)
{
	...
	mode1_buff[1] = 0x05;  // 
	mode1_buff[2] = 0x9E;  // 	
	bl0906_write_reg_function(BL0906_MODE1,mode1_buff,3,0);
}

/************************************************************
*
* Function name	: bl0910_set_mode2_function
* Description	: 设置模式
* Parameter		: 
* Return		: 
*	
************************************************************/
void bl0906_set_mode2_function(void)
{
	...
	mode2_buff[1] = 0x82;  // 
	mode2_buff[2] = 0xA8;  // 	
	bl0906_write_reg_function(BL0906_MODE2,mode2_buff,3,0);
}

/************************************************************
*
* Function name	: bl0910_set_ADC_PD_function
* Description	: 设置ADC_PD寄存器
* Parameter		: 
* Return		: 
*	
************************************************************/
void bl0910_set_ADC_PD_function(void)
{
	uint8_t adc_buff[3] = {0};
	
	adc_buff[0] = 0x00;  // 
	adc_buff[1] = 0x04;  // 
	adc_buff[2] = 0xC2;  // 	
	bl0906_write_reg_function(BL0906_ADC_PD,adc_buff,3,0);
}


/************************************************************
*
* Function name	: bl0906_set_eng_rst_function
* Description	: 能量读后清零
* Parameter		: 
* Return		: 
*	
...
/************************************************************
*
* Function name	: bl0906_reset_numreg_function
...
//	bl0906_read_reg_function(BL0906_SAGLVL,0);  // 默认值是0x1010
//	delay_us(20);	
//	bl0906_read_reg_function(BL0906_WA_CREEP,0);  // 默认值是0x1010
//	delay_us(20);	
//	bl0906_read_reg_function(BL0906_FAST_RMS_CTRL,0);  // 默认值是0x1010
//	delay_us(20);	
	while(1)
	{
	  bl0906_read_reg_function(0x88,0);  // 默认值是0x1010
...
//		hardSPI_ReadWriteByte(8);
//    bl0906_hard_spi_delay(8000);
