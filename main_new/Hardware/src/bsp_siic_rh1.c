 ...
 * @retval      无
 */
void rh1_iic_send_byte(uint8_t data)
{
    uint8_t t;
 ...
 * @retval      接收到的数据
 */
uint8_t rh1_iic_read_byte(uint8_t ack)
{
    uint8_t i, receive = 0;
