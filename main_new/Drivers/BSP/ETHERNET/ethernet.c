...
void HAL_ETH_MspInit(ETH_HandleTypeDef *heth)
{
    ...
    /* 高电平，不使能复位 */
    HAL_GPIO_WritePin(ETH_ADDR_GPIO_PORT, ETH_ADDR_GPIO_PIN, GPIO_PIN_RESET);
    /* 复位引脚配置 */
    gpio_init_struct.Pin = ETH_ADDR_GPIO_PIN;
    gpio_init_struct.Mode = GPIO_MODE_OUTPUT_PP;
    gpio_init_struct.Pull = GPIO_NOPULL;
    gpio_init_struct.Speed = GPIO_SPEED_FREQ_HIGH;
    HAL_GPIO_Init(ETH_ADDR_GPIO_PORT, &gpio_init_struct);  
